...
import data_structure.common.gen_rand
from data_structure.sort.select_sort import select_sort
...
if __name__ == '__main__':
    for i in range(100):
        lst = select_sort(data_structure.common.gen_rand.gen_rand_list(10))
